    ...
    return (
        <Card>
            <CardActionArea onClick={() => navigate(`${pathname}/${content.fields.slug}`, { state: { data: slug } })}>
                <CardMedia loading="lazy" component="img" sx={{ height: { xs: '100%', sm: '100%', md: '36vw', xl: 600 }, width: { xs: '100%', sm: '100%' } }} src={content?.fields.coverImage.fields.file.url} alt={content.fields.coverImage.fields.title} />
