    ...
    return (
        <Card>
            <CardActionArea onClick={() => navigate(`${pathname}/${content.fields.slug}`, { state: { data: slug } })}>
                <LoadingImage sx={{ transition: "opacity .15s linear", height: { xs: '100%', sm: '100%', md: '36vw', xl: 600 }, width: { xs: '100%', sm: '100%' } }} src={content?.fields.coverImage.fields.file.url} alt={content.fields.coverImage.fields.title} />
